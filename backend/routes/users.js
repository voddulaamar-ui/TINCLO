...
// POST /api/users — legacy user creation (kept for backwards compat)
...
// GET /api/users/data — admin full summary
...
// GET /api/users/:userId — public (needed by StateManager.ensureUserExists)
